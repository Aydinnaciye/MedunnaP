...
public class Student {
    ...
    2)protected
    3)default
    4)private public > protected > default > private
    ...
    private ==> private olanlar sadece olusturulduklari class icinden kullanilabilirler
     ...
     Cevap: protected olanlar baska package'lardan kullanilamaz ancak baska
      package'larda child classlar icinden kullanilabilir.
      default olanlar baska package'lardan kullanilamazlar */

    public String stdName = "Ali Can";
    protected String address = "Istanbul";
    String email ="alican@gmail.com";//Hicbirsey yazmazsak default olur,
