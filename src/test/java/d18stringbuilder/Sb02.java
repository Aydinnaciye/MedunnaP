...
public class Sb02 {
    public static void main(String[] args) {
        //capacity() methodu, ayrılmış olan ve henüz kullanılmayan karakter alanının
        ...
        StringBuilder sb2 = new StringBuilder();//Stringbuilder yazinca java 16 lik kapasite hazirlar.
        ...
        //                                 16x2=32+2=34 0lur(2 kati, 2 fazlasi)
        ...
        length ise size verilen data depolama yerinin kullanilan kismidir
         ...
         Siz eger verilen bu capacity'i asarsaniz
         Java yeni capacity'i var olanin 2 katinin 2 fazlasi olacak sekilde ayarlar
        ...
        System.out.println(sb3.capacity());//8,,3*2=6+2=8(3 ü 2 ile carpip 2 ekledi)
        ...
        sb4.append("xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx");//Buraya 20 tane x daha eklersek.
