...
public class PassByValuePassByValue {
    public static void main(String[] args) {
       ...
       ***Dikkat : Java da Object ile calisirken (heap memory'de), Object'in referansı(adresi)
        degismez ama bazi Object'lerin orjinal içeriği degisebilir
        ...
        1- Güvenlik: "Pass by Value," verilerin kontrolsüz değiştirilmesini engeller.
        ...
        2-Performans: Pass by value, Java'nın performans açısından daha verimli çalışmasını sağlar.
