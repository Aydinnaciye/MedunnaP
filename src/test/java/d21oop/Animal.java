...
public class Animal {
    ...
    */
    ...
    //--------------------
    //Override isleminde access modifier larin durumlari ne olmalidir.Public

    //Simdi de retur type durumlarina bakalim
    //Parent icinde data tipi olan bir metot olusturup childde override edelim.

    //Parentta int veri turunde bir method acip, childde override etseydik ne olurdu?

    //Peki parent class veri turunde bir metot acip,childda override etseydik ne olurdu?
    ...
    public Animal create(){//her class ismi o clasindata type olabilir.
        return new Animal();
        //Animal clastan bir obje ürettik.
        // Ve objemizi Animal data tipi ile metod disina(return ettik) gönderdim
    ...
    public Number multiply (Integer a, Integer b){//Number Integerin parentidir.
        return a * b;
    }
    public void drink() {
